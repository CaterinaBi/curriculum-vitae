...
\item Currently working towards the establishment of a large Romance dataset (with a 3T target). 
\end{tightemize}
\sectionsep
...
\runsubsection{NLP CLASSIFIER TO STOP ONLINE VIOLENCE AGAINST CHILDREN}
\descript{| Python, Selenium.}
\location{Repo: \href{https://omdena.com/projects/stop-online-violence-against-}{nlp-classifier-omdena-marseille}}
\begin{tightemize}
