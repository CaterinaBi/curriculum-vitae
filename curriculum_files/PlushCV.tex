...
\sectionsep
\begin{tightemize}
\item Core skills: Excel for data analysis and visualisation, Python, MatPlotLib, SQL, LaTeX, Microsoft Word and Power Point.
\end{tightemize}
\sectionsep
...
\sectionsep
\begin{tightemize}
\item Core skills: Excel for data analysis and visualisation, Python, Praat, LaTeX, Microsoft Word and Power Point.
\end{tightemize}
\sectionsep
...
\subsection{Udacity}
\descript{Programming in Python for AI}
\location{(In progress)}

\sectionsep

\subsection{AiCore}
\descript{Python Programmer Certificate}
\location{September 2022}

\sectionsep

\subsection{Université de Genève}
\descript{Certificate of Specialisation in Linguistics}
