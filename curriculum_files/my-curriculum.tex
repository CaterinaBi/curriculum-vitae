...
\highlightbar{
    ...
    \email{catherinebonan@gmail.com}
    \phone{+44(0)7983818663}
    ...
    \vspace{0.5em}
    \skillsection{Linguistics}
    Syntax, Language documentation, Qualitative Research, Quantitative Research, Fieldwork, IPA.
    
    \vspace{0.5em}
    \skillsection{Languages}
    \skill{Italian (native)}{5}
    \skill{French}{5}
    \skill{English}{5}
    \skill{Spanish}{2}
    \bigskip
